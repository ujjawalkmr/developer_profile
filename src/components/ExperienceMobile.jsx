...
export default function ExperienceMobile() {
    return (
        <section id="education" className="mobile-experience-section">
            <div className="mobile-experience-wrapper">
                ...
                <div className="mobile-timeline-axis-container">
                    ...
                    <div className="mobile-experience-vertical-list">
                        {educationData.map((card) => (
                            <div key={card.id} className="mobile-experience-timeline-row">
                                ...
                                <div className="mobile-experience-card">
                                    ...
                                    <div className="mobile-experience-card-right-panel">
                                        <h3 className="mobile-experience-institute-name">{card.institute}</h3>
                                        <h4 className="mobile-experience-card-title">{card.title}</h4>
