...
const ServiceMobile = () => {
  ...
  return (
      ...
      {selectedService && (
        <div className="mobile-service-modal-overlay" onClick={closeModal}>
          <div className="mobile-service-modal-content" onClick={(e) => e.stopPropagation()}>
            <button className="mobile-service-modal-close" onClick={closeModal}>&times;</button>
            <div className="mobile-service-modal-header">
               <span className="mobile-service-modal-icon">{selectedService.icon}</span>
